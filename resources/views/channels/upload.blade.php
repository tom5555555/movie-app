        ...
        <channel-uploads :channel="{{ $channel }}" inline-template>
            <div class="col-md-8">
                <div v-if="!selected" class="card p-3 d-flex justify-content-center align-items-center">
                    ...
                    <input multiple @change="upload" type="file" style="display:none; " id="video-files" ref="videos">
                    
                <p class="text-center">ビデオのアップロード</p>
                </div>

                <div class="card p-3" v-else>
                        <div class="my-4" v-for="video in videos">
                            <div class="progress mb-3">
                                <div class="progress-bar progress-bar-striped progress-bar-animated" :style="{width:`${video.percentage || progress[video.name]}%`}"   role="progressbar"  aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                    @{{ video.percentage ? video.percentage === 100 ? "アップロード完了です。 " :"処理中です。" : "アップロード中です。"}}
                                </div>
                            </div>
                            <div class="row">
